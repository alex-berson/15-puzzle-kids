...
const newGame = () => {
    ...
    document.body.removeEventListener('touchstart', newGame);
    document.body.removeEventListener('mousedown', newGame);

    chars.forEach(char => char.classList.remove('gray-c'));
    tiles.forEach(tile => tile.classList.remove('zoom', 'gray-t'));
...
const firework = () => {
    ...
    const zoom = () => {
        ...
        if (n % 2 == 0) chars[n / 2].classList.add('gray-c');
        ...
        tiles[n].addEventListener('transitionend', e => {
            ...
            tile.addEventListener('transitionend', () => {
                ...
                if (n == 15) {
                    ...
                    document.body.addEventListener('touchstart', newGame);
                    document.body.addEventListener('mousedown', newGame);
